  ...
  return (
    ...
    >
      <section className="flex w-full flex-col gap-4">
        ...
        <div className="w-full rounded-sm bg-gray-100 px-[18px] py-4">
      ...
      <section className="flex flex-col items-center gap-[23px]">
        <Icon role="img" aria-label={name} className="h-[145px] w-[159px]" />
        <div className="flex items-center gap-[7px] rounded-[20px] border border-gray-200 bg-white px-4 py-1.5">
